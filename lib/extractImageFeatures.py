...
import sys
sys.path.append("/media/matthieu/Documents/2016_2017_3A_Mines_Paristech/MVA/Recvis/Project/caffe-cl/caffe/build/install/python") # path to caffe
import caffe
...
def extractImageFeatures(dataType):
    ...
    # setting computational mode to CPU or GPU
    caffe.set_mode_cpu()
    #caffe.set_device(0)
    #caffe.set_mode_gpu()
